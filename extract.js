...
export async function extrairConteudo(page) {
  ...
  // page.request reaproveita os cookies da sessão logada no navegador headless
  ...
  // Arquivos/materiais de disciplina ficam pra uma segunda etapa
  // (endpoint diferente, ainda não mapeado)
